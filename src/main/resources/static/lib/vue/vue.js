...
(function (global, factory) {
  ...
  /**
   * unicode letters used for parsing views tags, component names and property paths.
...

  {
    ...
    var warnNonPresent = function (target, key) {
      warn(
        ...
        'See: https://vuejs.org/v2/guide/reactivity.views#Declaring-Reactive-Properties.',
        target
      );
    };
  ...
  function initData (vm) {
    ...
    if (!isPlainObject(data)) {
      ...
      warn(
        ...
        'https://vuejs.org/v2/guide/components.views#data-Must-Be-a-Function',
        vm
      );
    }
  ...
  var isHTMLTag = makeMap(
    'views,body,base,head,link,meta,style,title,' +
  ...
  function createPatchFunction (backend) {
    ...
    function removeNode (el) {
      ...
      // element may have already been removed due to v-views / v-text
      if (isDef(parent)) {
      ...
      if (isDef(tag)) {
        if (isDef(children)) {
          ...
          if (!elm.hasChildNodes()) {
            ...
            // v-views and domProps: innerHTML
  ...
  var isNonPhrasingTag = makeMap(
    ...
    'h1,h2,h3,h4,h5,h6,head,header,hgroup,hr,views,legend,li,menuitem,meta,' +
  ...
  function genFor (
    ...
    if (state.maybeComponent(el) &&
      ...
      state.warn(
        ...
        "See https://vuejs.org/guide/list.views#key for more info.",
        el.rawAttrsMap['v-for'],
        true /* tip */
      );
    }
  ...
  Vue.prototype.$mount = function (
    ...
    if (el === document.body || el === document.documentElement) {
      warn(
        "Do not mount Vue to <views> or <body> - mount to normal elements instead."
      );
      return this
    }
